...
async function listar(context) {
  let query = "SELECT id_bodega, nombre, direccion, estado, encargado, id_sede, (SELECT nombre FROM usuario WHERE id_usuario = b.encargado) as nombre_encargado FROM bodega b";
  const binds = [];
...
async function listar2(context) {
...
module.exports.listar2 = listar2;